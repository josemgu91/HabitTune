...
public class ActivityMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, FragmentInteractionListener, StateChanger {
    ...
    @Override
    public void navigateToFragmentUpdateRoutineEntry(@NonNull String id) {
        backstackDelegate.getBackstack().goTo(fragmentKeyFactory.createUpdateRoutineEntryKey(id));
    }
