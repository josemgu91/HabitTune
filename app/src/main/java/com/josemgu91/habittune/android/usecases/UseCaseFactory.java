...
public interface UseCaseFactory {
    ...
    GetActivities createGetActivities(UseCaseOutput<LiveData<List<GetActivities.Output>>> output);

    CreateActivity createCreateActivity(UseCaseOutput<Void> output);
