...
public class UpdateRoutineEntry extends AbstractUseCase<UpdateRoutineEntry.Input, Void> {

    private final RoutineDataGateway routineDataGateway;

    public UpdateRoutineEntry(@NonNull Executor outputExecutor, @NonNull Executor useCaseExecutor, RoutineDataGateway routineDataGateway) {
    ...
    protected void executeUseCase(@Nullable Input input, @NonNull UseCaseOutput<Void> output) {
        output.inProgress();
        try {
            final boolean routineEntryUpdated = routineDataGateway.updateRoutineEntry(
                    new RoutineEntry(
                            input.id,
    ...
    public static final class Input {
        ...
        public Input(@NonNull String id, @NonNull String routineId, @NonNull String activityId, int day, int startTime, int endTime) {
            this.id = id;
